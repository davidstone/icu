...
public:
     ...
     */
    UBool operator==(const UVector32& other) const;

    /**
     * Equivalent to !operator==()
     */
    inline UBool operator!=(const UVector32& other) const;
...
inline UBool UVector32::operator!=(const UVector32& other) const {
