...
public:
     ...
     */
    UBool operator==(const UVector64& other) const;

    /**
     * Equivalent to !operator==()
     */
    inline UBool operator!=(const UVector64& other) const;
...
inline UBool UVector64::operator!=(const UVector64& other) const {
